...
function createBrowserLocalApi(): LocalApi {
  return {
    ...
    speechToText: {
      transcribe: () => Promise.reject(unavailableLocalBackendError()),
    },
    antigravity: {
      listAccounts: () => Promise.reject(unavailableLocalBackendError()),
      detectAccount: () => Promise.reject(unavailableLocalBackendError()),
      saveAccount: () => Promise.reject(unavailableLocalBackendError()),
      switchAccount: () => Promise.reject(unavailableLocalBackendError()),
      removeAccount: () => Promise.reject(unavailableLocalBackendError()),
      dismissDetectedAccount: () => Promise.reject(unavailableLocalBackendError()),
    },
  };
}
