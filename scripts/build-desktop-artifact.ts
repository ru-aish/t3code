...
export class DesktopBuildArtifactReplaceError extends Schema.TaggedErrorClass<DesktopBuildArtifactReplaceError>()(
  "DesktopBuildArtifactReplaceError",
  {
  ...
  override get message(): string {
    return `Failed to replace ${this.destinationPath}. Close any running copy of this artifact and retry.`;
  }
}
    ...
    yield* fs.rename(tempTo, to).pipe(
      Effect.catch((cause) =>
        Effect.gen(function* () {
          ...
          return yield* new DesktopBuildArtifactReplaceError({
            destinationPath: to,
            temporaryPath: tempTo,
            cause,
          });
        }),
      ),
